...
#define SP_SER_SZ_OFFSET (SP_DID_OFFSET + SP_DID_LEN)
#define SP_SER_SZ_LEN 1
#define SP_SER_NUM_OFFSET (SP_SER_SZ_OFFSET + SP_SER_SZ_LEN)
#define SP_TOP_TYPE_OFFSET (SP_DID_OFFSET + SP_DID_LEN)
#define SP_TOP_TYPE_LEN 1
#define SP_TOP_TYPE_MATRIX 0x11
#define SP_TOP_MAT_DESC_OFFSET SP_TOP_TYPE_OFFSET
#define SP_TOP_MAT_DESC_LEN SP_TOP_TYPE_LEN
#define SP_TOP_ECD_OFFSET (SP_TOP_MAT_DESC_OFFSET + SP_TOP_MAT_DESC_LEN)
#define SP_TOP_ECD_SZ_LEN 1
...
// Topology Types
#define SP_TOP_TYPE_MAT_START 0x11
